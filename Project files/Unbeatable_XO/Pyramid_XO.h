...
namespace UnbeatableXO {
	...
	/// <summary>
	/// Summary for Pyramid_XO
	/// </summary>
	public ref class Pyramid_XO : public System::Windows::Forms::Form
	{
	public:
		Pyramid_XO(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		/// </summary>
		bool is_winner() {
			if (button1->Text != "" && button1->Text == button4->Text && button4->Text == button9->Text) {
			...
			if (button1->Text != "" && button1->Text == button2->Text && button2->Text == button5->Text) {
				this->button1->BackColor = System::Drawing::SystemColors::WindowFrame;
			...
			if (button6->Text != "" && button6->Text == button7->Text && button7->Text == button8->Text) {
				this->button6->BackColor = System::Drawing::SystemColors::WindowFrame;
				this->button7->BackColor = System::Drawing::SystemColors::WindowFrame;
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(556, 192);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(116, 113);
			this->button1->TabIndex = 0;
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(431, 311);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(116, 113);
			this->button2->TabIndex = 1;
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button3
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(556, 311);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(116, 113);
			this->button3->TabIndex = 2;
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button4
			// 
			...
			this->button4->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button4->Location = System::Drawing::Point(678, 311);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(116, 113);
			this->button4->TabIndex = 3;
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button5
			// 
			...
			this->button5->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button5->Location = System::Drawing::Point(309, 430);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(116, 113);
			this->button5->TabIndex = 4;
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button6
			// 
			...
			this->button6->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button6->Location = System::Drawing::Point(431, 430);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(116, 113);
			this->button6->TabIndex = 5;
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button7
			// 
			...
			this->button7->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button7->Location = System::Drawing::Point(556, 430);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(116, 113);
			this->button7->TabIndex = 6;
			this->button7->UseVisualStyleBackColor = false;
			this->button7->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button8
			// 
			...
			this->button8->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button8->Location = System::Drawing::Point(678, 430);
			this->button8->Name = L"button8";
			this->button8->Size = System::Drawing::Size(116, 113);
			this->button8->TabIndex = 7;
			this->button8->UseVisualStyleBackColor = false;
			this->button8->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// button9
			// 
			...
			this->button9->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button9->Location = System::Drawing::Point(800, 430);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(116, 113);
			this->button9->TabIndex = 8;
			this->button9->UseVisualStyleBackColor = false;
			this->button9->Click += gcnew System::EventHandler(this, &Pyramid_XO::button_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(476, 119);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Tw Cen MT Condensed Extra Bold", 19.8F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(653, 119);
			...
			this->button10->Click += gcnew System::EventHandler(this, &Pyramid_XO::button10_Click);
			// 
			// Pyramid_XO
			// 
			...
			this->ClientSize = System::Drawing::Size(1255, 726);
			...
			this->Name = L"Pyramid_XO";
			this->Text = L"Pyramid_XO";
